...
{
  c=rnorm(i,mean = 0,sd=1)
  sdcor[i/100]=sd(c)
  sdncor[i/100]=((i-1)/i)*sd(c)
}
plot(seq(1:100),rep(1,100),col="black",type="l",ylim=c(0.9,1.1),xlab="n*100",ylab="")
points(seq(1:100),sdncor,col="red",cex=0.5)
points(seq(1:100),sdcor,col="blue",cex=0.7)
